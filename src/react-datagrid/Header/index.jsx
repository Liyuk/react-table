...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        var title = props.showGroupName ?
            <div className="z-header z-sub-header-title">{props.title}</div> : null;
        return (
    ...
    renderCell: function(props, state, column, index){
        ...
        var menu = column.hideMenu ? null : this.renderColumnMenu(props, state, column, index)
    ...
    renderCellContent(column, contentProps, text, props){
        if (column.columns) {
            return this.props.renderSubHeader(column);
        } else {
            return React.DOM.div(contentProps, text)
        }
    },
